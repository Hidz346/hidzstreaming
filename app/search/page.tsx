      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-5">
          ...
          <AnimeList items={results.map((r: any) => ({
            ...
            href: source === 'donghua' ? r.href : source === 'komik' ? `/comic/detail/${r.slug}` : `/detail?url=${encodeURIComponent(r.url)}&source=${source}`,
            episodes: source === 'komik' ? (r.description || '') : r.episodes
          }))} />
        </div>
