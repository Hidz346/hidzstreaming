  ...
  useEffect(() => {
    ...
    const fetchDetail = async () => {
      try {
        ...
        const dataPayload = raw?.data || raw?.result;
        if (dataPayload) {
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-[1600px] mx-auto pt-8 pb-6 flex flex-col md:flex-row gap-6 md:gap-10">
        ...
        <div className="w-full md:w-[300px] xl:w-[350px] flex flex-col items-center md:items-start shrink-0">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-2 mb-4">
            <span className="px-3 py-1 bg-pink-500 text-white text-[10px] font-bold rounded uppercase tracking-wider">HidzNovel</span>
        ...
        <div className="bg-[#151728] rounded-2xl p-5 border border-zinc-800/50">
          ...
          <button onClick={() => setIsExpanded(!isExpanded)} className="text-pink-500 text-sm font-bold hover:underline">
