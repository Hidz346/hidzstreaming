...
import { ChevronLeft, ChevronRight, Play, Monitor, Download, List, ExternalLink } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    fetch(`/api/donghua/episode?id=${encodeURIComponent(episodeId)}`)
      ...
      .then(result => {
        ...
        // Simpan ke riwayat nonton (localStorage)
        try {
          ...
          if (novelUrl) {
            ...
            localStorage.setItem('hidz_history', JSON.stringify(history));
          }
        } catch (e) {
